var t,e,i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},s={},n=i.parcelRequirea202;null==n&&((n=function(t){if(t in o)return o[t].exports;if(t in s){var e=s[t];delete s[t];var i={id:t,exports:{}};return o[t]=i,e.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){s[t]=e},i.parcelRequirea202=n);var a=n.register;a("cw9o9",function(t,e){var i=n("hffE7");t.exports=i("6z40I").then(()=>n("aexh3"))}),a("hffE7",function(t,e){t.exports=function(t){return import(n("kyEFX").resolve(t))}});let r=(t="",e="")=>{let i=Math.random().toString(36).substring(2,8);return`${"string"==typeof t&&""!==t?t+"-":""}${i}${"string"==typeof e&&""!==e?"-"+e:""}`},l=(t,e)=>{if(Object.prototype.hasOwnProperty.call(e,t)){let i=e[t];delete e[t],e[t]=i}},d=0,c=`
  :host {
...
`;class tM extends HTMLElement{#t=null;#e;#o;#i;#a;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tN.content.cloneNode(!0))),this.#e=this.shadowRoot.querySelector("button"),this.#o=this.shadowRoot.querySelector('slot[name="copy"]'),this.#i=this.shadowRoot.querySelector('slot[name="success"]'),this.#a=this.shadowRoot.querySelector('slot[name="error"]')}static get observedAttributes(){return["disabled"]}connectedCallback(){this.#r("value"),this.#r("from"),this.#r("disabled"),this.#r("feedbackDuration"),this.#e.addEventListener("click",this.#l)}disconnectedCallback(){this.#e.removeEventListener("click",this.#l),this.#s()}attributeChangedCallback(t){"disabled"===t&&(this.#e.disabled=this.disabled,this.#e.setAttribute("aria-disabled",this.disabled.toString()),this.#e.part.contains("button")&&this.#e.part.toggle("button--disabled",this.disabled))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}get from(){return this.getAttribute("from")}set from(t){this.setAttribute("from",t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get feedbackDuration(){return Number(this.getAttribute("feedback-duration"))||1e3}set feedbackDuration(t){this.setAttribute("feedback-duration",t)}async #n(){if(this.value||this.from)try{let t="";if(this.value)t=this.value;else if(this.from){let e="getRootNode"in Element.prototype?this.#e.getRootNode({composed:!0}):this.#e.ownerDocument;if(!e||!(e instanceof Document||e instanceof ShadowRoot))return;let i=e.querySelector(this.from);if(!i)return;t=i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i instanceof HTMLAnchorElement&&i.hasAttribute("href")?i.href:i.textContent}await navigator.clipboard.writeText(t),this.#c(t_),this.dispatchEvent(new CustomEvent(`${tL}-success`,{bubbles:!0,composed:!0,detail:{value:t}}))}catch(t){this.#c(tR),this.dispatchEvent(new CustomEvent(`${tL}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}#l=t=>{t.preventDefault(),this.disabled||this.#t||this.#n()};#c(t){this.#o.hidden=!0,this.#i.hidden=t!==t_,this.#a.hidden=t!==tR,this.#e.part.remove("button--success"),this.#e.part.remove("button--error"),this.#e.part.add(`button--${t}`),this.#t&&clearTimeout(this.#t),this.#t=setTimeout(()=>{this.#o.hidden=!1,this.#i.hidden=!0,this.#a.hidden=!0,this.#e.part.remove(`button--${t}`),this.#t=null},this.feedbackDuration)}#s(){this.#t&&clearTimeout(this.#t),this.#t=null,this.#o.hidden=!1,this.#i.hidden=!0,this.#a.hidden=!0,this.#e.part.remove("button--success"),this.#e.part.remove("button--error")}#r(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=tL){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tM)}}class tO extends tM{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=`
    ...
    `}static get observedAttributes(){return[...super.observedAttributes,"only-icon"]}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"only-icon"===t&&e!==i){let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]'),i=t.querySelector(".text"),o=e.querySelector(".text");i&&(i.hidden=this.onlyIcon),o&&(o.hidden=this.onlyIcon)}}get onlyIcon(){return this.hasAttribute("only-icon")}set onlyIcon(t){t?this.setAttribute("only-icon",""):this.removeAttribute("only-icon")}connectedCallback(){super.connectedCallback(),this.#C("onlyIcon"),this.hasAttribute("feedback-duration")||this.setAttribute("feedback-duration","1500")}disconnectedCallback(){super.disconnectedCallback()}#C(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="custom-clipboard-copy"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tO)}}tO.defineCustomElement(),async function(){let t;let e="No barcode detected",i=document.querySelector("a-tab-group"),o=document.getElementById("cameraPanel"),s=document.querySelector("capture-photo"),a=document.getElementById("cameraResults"),r=document.getElementById("fileResults"),l=document.getElementById("scanInstructions"),d=document.getElementById("scanBtn"),c=document.getElementById("dropzone"),h=document.querySelector("resize-observer"),u=document.getElementById("scanFrame"),p=document.getElementById("globalActions"),b=document.getElementById("historyBtn"),m=document.getElementById("historyDialog"),g=document.getElementById("historyList"),f=document.getElementById("deleteHistoryBtn"),v=document.getElementById("settingsBtn"),w=document.getElementById("settingsDialog"),y=document.forms["settings-form"],E=document.getElementById("supportedFormats"),A=document.getElementById("apiBtn"),x=!0;if(!("BarcodeDetector"in window))try{await n("cw9o9")}catch(t){return p.hidden=!0,i.style.display="none",tT("BarcodeDetector API is not supported by your browser.","danger")}H()||document.querySelectorAll("web-share").forEach(t=>{t.hidden=!0,t.disabled=!0});let{value:z=[]}=await tx();_(z),s.addEventListener("capture-photo:video-play",t=>{u.hidden=!1,I(t.detail.video),$();let e=s.getTrackSettings(),i=s.getTrackCapabilities(),o=document.getElementById("zoomLevel");if(e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),n=i?.zoom?.min||0,a=i?.zoom?.max||10,r=e?.zoom||1;t.hidden=!1,o.textContent=r,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&r<a&&(r+=.5),i&&r>n&&(r-=.5),o.textContent=r,s.zoom=r})}},{once:!0}),s.addEventListener("capture-photo:error",t=>{let e=t.detail.error;if("NotFoundError"===e.name)return;let i="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;o.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${i}</div>`},{once:!0}),tp.defineCustomElement(),c.accept="image/jpg,image/jpeg,image/png,image/apng,image/gif,image/webp,image/avif";let k=s.shadowRoot.querySelector("video"),C=await window.BarcodeDetector.getSupportedFormats(),T=new window.BarcodeDetector({formats:C}),{value:S={}}=await tE();Object.entries(S).forEach(([t,e])=>{let i=y.querySelector(`[name="${t}"]`);i&&(i.checked=e)}),Array.isArray(C)&&C.length>0&&(E.textContent=`Supported formats: ${C.join(", ")}`);let L=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return async(e,i,o,s,n)=>{let{value:a}=await tE();if(!a?.beep)return;let r=t.createOscillator(),l=t.createGain();r.connect(l),l.connect(t.destination),o&&(l.gain.value=o),i&&(r.frequency.value=i),s&&(r.type=s),"function"==typeof n&&(r.onended=n),r.start(t.currentTime),r.stop(t.currentTime+(e||500)/1e3)}})();function _(t){g.innerHTML="",Array.isArray(t)&&t.length?(f.style.display="block",t.forEach(t=>{let e;let i=document.createElement("li");i.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch(t){e=document.createElement("span")}e.textContent=t,e.setAttribute("title",t);let o=document.createElement("div");o.className="history-modal__actions";let s=document.createElement("custom-clipboard-copy");s.title="Copy to clipboard",s.setAttribute("only-icon",""),s.setAttribute("value",t),o.appendChild(s);let n=document.createElement("button");n.type="button",n.className="history-modal__delete-action",n.title="Remove from history",n.setAttribute("data-action","delete"),n.innerHTML=`
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
          </svg>
        `,o.appendChild(n),i.appendChild(e),i.appendChild(o),g.appendChild(i)})):(g.innerHTML="<li class=>There are no saved items in history.</li>",f.style.display="none")}async function R(t){let{value:e}=await tE();if(!t||!e?.addToHistory)return;let{value:i=[],error:o}=await tx();if(!o&&!i.find(e=>e===t)){let e=[...i,t],{error:o}=await tz(e);o||_(e)}}async function N(t){if(!t)return;let{value:e=[],error:i}=await tx();if(!i){let i=e.filter(e=>e!==t),{error:o}=await tz(i);o||_(i)}}async function M(){let{error:t}=await tz([]);t||_([])}async function O(t=100){let{value:e}=await tE();if("function"==typeof window.navigator.vibrate&&e?.vibrate)try{window.navigator.vibrate(t)}catch{}}function I(t){if(!t)return;let e=t.getBoundingClientRect();u.style.cssText=`width: ${e.width}px; height: ${e.height}px`}function q(t){t?.querySelector(".results__item")?.remove()}async function D(t,i){let o;if(!t||!i)return;q(i);try{let{value:e}=await tE();new URL(t),(o=document.createElement("a")).href=t,e?.openWebPageSameTab||(o.setAttribute("target","_blank"),o.setAttribute("rel","noreferrer noopener")),e?.openWebPage&&o.click()}catch(t){o=document.createElement("span")}o.className="results__item",o.classList.toggle("results__item--no-barcode",t===e),o.textContent=t,i.insertBefore(o,i.querySelector(".results__actions"));let s=i.getElementById("apiBtn"),n=i.querySelector("custom-clipboard-copy"),a=i.querySelector("web-share"),r=t!==e;s&&(s.disabled=!r,s.hidden=!r),n&&(n.disabled=!r,n.hidden=!r),a&&H()&&(a.disabled=!r,a.hidden=!r,r?a.setAttribute("share-text",t):a.removeAttribute("share-text")),i.show()}function B(t){return new Promise((e,i)=>{T.detect(t).then(t=>{Array.isArray(t)&&t.length>0?e(t[0]):i({message:"Could not detect barcode from provided source."})}).catch(t=>{i(t)})})}async function $(){l.hidden=!1;try{let e={};e=await B(k),window.cancelAnimationFrame(t),q(a),D(e.rawValue,a),R(e.rawValue),l.hidden=!0,d.hidden=!1,u.hidden=!0,L(200,860,.03,"square"),O();return}catch(t){}x&&(t=window.requestAnimationFrame(()=>$()))}d.addEventListener("click",()=>{d.hidden=!0,u.hidden=!1,q(a),a.close(),$()}),i.addEventListener("a-tab-show",tS(t=>{let e=t.detail.tabId;if("cameraTab"===e){x=!0;let t=document.querySelector("capture-photo");!t||t.loading||a.querySelector(".results__item")||$(),null!=t&&"function"==typeof t.startVideoStream&&t.startVideoStream()}"fileTab"===e&&(x=!1,null!=s&&"function"==typeof s.stopVideoStream&&s.stopVideoStream())},250)),c.addEventListener("files-dropzone-drop",t=>{!function(t){if(!t)return;let i=new Image,o=new FileReader;o.onload=o=>{let s=o.target.result;i.onload=async()=>{try{let t=await B(i);q(r),D(t.rawValue,r),R(t.rawValue),L(200,860,.03,"square"),O()}catch(t){q(r),D(e,r)}},i.src=s,c.replaceChildren();let n=document.createElement("div");n.className="dropzone-preview";let a=document.createElement("div");a.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,a.appendChild(i),n.appendChild(a),n.appendChild(l),c.prepend(n)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),h.addEventListener("resize-observer:resize",()=>{I(s.shadowRoot.querySelector("video"))}),v.addEventListener("click",()=>{w.showModal()}),b.addEventListener("click",()=>{m.showModal()}),m.addEventListener("click",t=>{t.target===t.currentTarget&&m.close()}),w.addEventListener("click",t=>{t.target===t.currentTarget&&w.close()}),y.addEventListener("change",t=>{let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),tA(e)}),g.addEventListener("click",t=>{let e=t.target;e.closest('[data-action="delete"]')&&window.confirm("Delete item from history?")&&N(e.closest("li").dataset.value)}),f.addEventListener("click",()=>{window.confirm("Are you sure you want to empty history?")&&M()}),A.addEventListener("click",()=>{window.confirm("Are you sure you want to set it to API?")&&function(t){fetch("https://api.cubeiq.tech/api/neinstall/check",{method:"GET",headers:{"Content-Type":"application/json","Api-Key":"TEST_API_KEY"},body:JSON.stringify({barcode:t})}).then(t=>t.json()).then(t=>{console.log("Success:",t)}).catch(t=>{console.error("Error:",t)})}(document.getElementById("#fileResults .results__item").textContent)})}();
//# sourceMappingURL=index.57422702.js.map
